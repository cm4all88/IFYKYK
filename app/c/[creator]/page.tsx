        ...
        <header className="cp-header">
          <div className="cp-header-inner">
            ...
            <div className="cp-identity">
              ...
              {backstageHandle && (
                <Link href={`/c/${backstageHandle}`} className="cp-backstage">
              ...
              <div className="cp-channels">
                ...
                <div className="cp-channel-grid">
                  {channels.map((ch) => (
                    <Link
                      key={ch.id}
                      href={`/c/${spotlight.handle}/${ch.slug}`}
                  ...
                  {posts.map((p) => (
                    <li key={p.id} className="cp-post">
                      ...
                      <div className="cp-post-meta">
                        ...
                        {p.tier === "premium" && <span className="cp-post-lock">🔒 Premium</span>}
