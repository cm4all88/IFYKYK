...
export async function POST(req: NextRequest) {
  ...
  // Verify this subscription belongs to the fan
  ...
  if (!sub.stripe_subscription_id) return NextResponse.json({ error: "No Stripe subscription found" }, { status: 400 });
  ...
  // Cancel at period end — fan keeps access until billing period ends
