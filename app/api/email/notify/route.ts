...
import { sendWelcomeEmail, sendTipEmail, sendNewSubscriberEmail } from "@/lib/email";
      ...
      html: `
        <div style="font-family:-apple-system,sans-serif;max-width:540px;margin:0 auto;padding:32px 24px;background:#09090C;color:#F2F2F0;">
          ...
          <div style="margin-top:28px;">
            <a href="https://spotlightly.app/dashboard" style="display:inline-block;background:#F0B429;color:#0A0A0D;font-size:13px;font-weight:700;padding:12px 24px;border-radius:999px;text-decoration:none;">
              Go to dashboard →
            </a>
          </div>
          <div style="height:1px;background:rgba(255,255,255,0.08);margin:28px 0 16px;"></div>
          <p style="font-size:11px;color:rgba(242,242,240,0.3);margin:0;">
            Spotlightly · Tahoma Systems LLC
          </p>
        </div>
      `,
    });
