...
export const CAMPAIGN_CATEGORIES: CampaignCategory[] = [
  {
    ...
    tiers: [
      ...
      { amount: 25, title: "✈️ Travel Companion", description: "You see the trip the way I see it.", rewards: [r("update", "Backer updates from the road"), r("recognition", "Name on the supporter wall"), r("content", "Behind the scenes photos")] },
  ...
  },
  {
    ...
    tiers: [
      ...
      { amount: 50, title: "🛠️ Collaborator", description: "The full making of, start to finish.", rewards: [r("content", "Process posts and work in progress"), r("content", "Exclusive behind the work content"), r("content", "Early look at the finished piece")] },
  ...
  },
  {
    ...
    tiers: [
      { amount: 10, title: "✏️ Sketch Crew", description: "You keep the pencils moving.", rewards: [r("update", "Backer updates from the studio"), r("recognition", "Name on the supporter wall")] },
      { amount: 25, title: "🖌️ Studio Friend", description: "You see what the new supplies become.", rewards: [r("update", "Backer updates from the studio"), r("content", "Work in progress photos")] },
      ...
      { amount: 100, title: "🖼️ Collector", description: "You helped restock the whole studio.", rewards: [r("recognition", "Founding backer status"), r("content", "Studio process videos"), r("physical", "A small original piece")] },
  ...
  },
  {
    ...
    tiers: [
      ...
      { amount: 100, title: "🛡️ Guardian", description: "You helped lift a real weight.", rewards: [r("recognition", "Founding supporter status"), r("recognition", "A personal note from me")] },
  ...
  },
  {
    ...
    tiers: [
      ...
      { amount: 250, title: "🗝️ Cornerstone", description: "A part of the next chapter.", rewards: [r("recognition", "Named in the next chapter"), r("content", "First content from the new home")] },
    ],
    rewardSuggestions: [
  ...
  },
  {
    ...
    tiers: [
      ...
      { amount: 50, title: "🎟️ Backer", description: "The full story, up close.", rewards: [r("content", "Exclusive behind the scenes content"), r("content", "Early access content"), r("recognition", "Founding backer status")] },
