...
export const TIER_NICHES: TierNiche[] = [
  ...
  },
  {
    ...
    tiers: [
      t("Sketchbook", 5, "A look inside the sketchbook.", ["Members only updates", "Work in progress shots", "Name in the supporter list"]),
      ...
      t("Patron", 50, "The closest seat to the easel.", ["Everything in Studio", "Monthly mini commission slot", "Early access to print drops", "Vote on what I make next"]),
    ],
  },
  {
  ...
  },
  {
    ...
    tiers: [
      ...
      t("Member", 12, "The full archive and then some.", ["Everything in Reader", "Full back catalog", "Bonus episodes and outtakes", "Monthly members only thread"]),
      t("Inner Circle", 35, "A seat at the table.", ["Everything in Member", "Ad free everything", "Monthly live Q and A", "Vote on future topics"]),
    ],
  },
  {
